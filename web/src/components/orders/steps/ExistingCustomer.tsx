...
function ClienteExistente() {
  ...
  function selecionarAparelho(imei: string) {
  ...
  return (
    <div className=" space-y-6 p-4 sm:p-6">
      <section className=" rounded-2xl border border-border bg-card p-5 shadow-sm">
        <h2 className="  mb-1 text-xl  font-bold text-foreground  ">Cliente</h2>
      ...
      <section className=" rounded-2xl border border-border bg-card p-5 shadow-sm ">
        <h2 className=" mb-1 text-xl  font-bold  text-foreground ">Aparelho</h2>
        ...
        <div className=" flex flex-col  gap-3  sm:flex-row">
          <select
            ...
            onChange={(e) => selecionarAparelho(e.target.value)}
          >
      ...
      <section className=" rounded-2xl border border-border bg-card p-5  shadow-sm">
        <h2 className=" mb-5 text-xl font-boldtext-foreground">
          Ordem de Serviço
        </h2>
